...
public class Government {
    ...
    public static class CabinetMember {
        ...
        public void setPosition(CabinetPosition position) { this.position = position; }
    ...
    public static class ApprovalRating {
        ...
        public void setRating(int rating) { this.rating = rating; this.timestamp = System.currentTimeMillis(); }
    }

    // Getters and Setters
    public UUID getPresidentUUID() { return presidentUUID; }
    public void setPresidentUUID(UUID presidentUUID) { this.presidentUUID = presidentUUID; }
    ...
    public Map<CabinetPosition, CabinetMember> getCabinet() { return cabinet; }
    public void setCabinet(Map<CabinetPosition, CabinetMember> cabinet) { this.cabinet = cabinet; }
    public long getLastDailyReward() { return lastDailyReward; }
    public void setLastDailyReward(long lastDailyReward) { this.lastDailyReward = lastDailyReward; }
    public long getLastPresidentActivity() { return lastPresidentActivity; }
    public void setLastPresidentActivity(long lastPresidentActivity) { this.lastPresidentActivity = lastPresidentActivity; }
    public List<ApprovalRating> getApprovalRatings() { return approvalRatings; }
    public void setApprovalRatings(List<ApprovalRating> approvalRatings) { this.approvalRatings = approvalRatings; }
    public double getCurrentApprovalRating() { return currentApprovalRating; }
    public void setCurrentApprovalRating(double currentApprovalRating) { this.currentApprovalRating = currentApprovalRating; }
