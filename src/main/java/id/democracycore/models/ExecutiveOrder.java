...
public class ExecutiveOrder {
    ...
    public enum ExecutiveOrderType {
        ...
        public String getDescription() { return effectDescription; }
    }

    public ExecutiveOrderType getType() { return type; }
    public void setType(ExecutiveOrderType type) { this.type = type; }
    ...
    public boolean isExpired() {
        if (type.getDefaultDuration() == 0) return true;
